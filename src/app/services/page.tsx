    ...
    return (
        <>
            <section className="relative mt-30 w-full md:mt-40 lg:mt-50">
                <div className="font-montserrat400 block px-6 py-8 text-center md:hidden">
                    <h3 className="mb-4 text-2xl font-bold">Web Development</h3>
                ...
                <div className="h-[500px] w-full">
                    ...
                    <div className="font-montserrat400 absolute top-[-100] right-[-120] hidden w-[80%] -translate-x-1/2 transform rounded-xl bg-white px-25 py-12 text-center sm:w-[70%] md:block md:w-[50%]">
            ...
            <div className="font-montserrat400 mx-5 mt-20 md:mx-20">
                ...
                <section className="mt-10">
                    <div className="mx-auto grid max-w-full grid-cols-1 items-stretch gap-6 md:grid-cols-[0.6fr_1.2fr]">
                        ...
                        <div className="flex h-full flex-col justify-between gap-6">
                            ...
                            <div className="flex-1 rounded-md bg-[#fbfbff] p-5 shadow-md">
                                <h3 className="text-md mb-7 font-semibold">
                ...
                <div className="mt-10 max-w-full rounded-xl bg-[#fbfbff] px-6 py-4 shadow-md">
                ...
                <div className="my-20 w-full px-6 text-center md:px-20">
                    <h1 className="mb-6 text-3xl font-black md:text-5xl">
